...
public class Inventario extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Entrada(Compra)", "Salida(Merma)", "Ajuste" }));

        txtArea.setColumns(20);
        txtArea.setRows(5);
        jScrollPane3.setViewportView(txtArea);

        jButton5.setBackground(new java.awt.Color(214, 162, 63));
        jButton5.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
        jButton5.setText("Registrar Movimiento");

        jButton6.setBackground(new java.awt.Color(214, 162, 63));
        jButton6.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
        jButton6.setText("Ver Movimientos");
